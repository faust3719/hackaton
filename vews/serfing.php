<!DOCTYPE html>
    ...
    function init(){
        ...
        placemark = new ymaps.Placemark([53.35005, 83.75985], {
            ...
            balloonContent: '<a href = "/view/66" style = "cursor: pointer; text-decoration: none; color: black"><div class="title"><div>Цена: 150p</div><img src = "./tamplate/img/174150_603x354.jpg" hspsce = "10px" width = "100%" height = "auto"><h3>Очень важный общественный проект</h3></div><div class="progress" style = "opacity: 0.7; position:relative"><div style = "width:100%; font-size: 15px; text-align:center; position : absolute; top:0; color: black">10 000/60 000</div><div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div></div><div class="owerview">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a</div></a><button type = "button" class = "btn btn-primary w-100">Я пойду</button>'
        });
