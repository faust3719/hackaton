  ...
  cursor: pointer;
 	...
 	<div class = "row">
      ...
      <input type="hidden" name="location" id = "location">
			<div class="face_icon" style="text-align: center; font-size: 50px;"><i class="fas fa-user-circle"></i></div>
			<ul class="list-group" >
		...
		<div class = "col-md-9 col-sm-8" style="padding:0">
				  <div id="map" style="width:100%; height:100vh; min-height: 100%"><span class="dg-zoom__hide" title="Скрыть меню"><div id ="sidebarCollapse"  onclick="collapse()"  class="dg-zoom__button_type_hide"><i class="fas fa-bars"></i></div></span></div>
		</div> 
  </div>
	<!-- Подключаем jQuery -->
